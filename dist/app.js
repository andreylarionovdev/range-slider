...
/* harmony import */ var _View_Slider_View__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../View/Slider/View */ "./src/ts/View/Slider/View.ts");
/* harmony import */ var _Presenter_Presenter__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../Presenter/Presenter */ "./src/ts/Presenter/Presenter.ts");



class App {
    constructor(target, options) {
        new _Presenter_Presenter__WEBPACK_IMPORTED_MODULE_2__["default"](new _View_Slider_View__WEBPACK_IMPORTED_MODULE_1__["default"](target), new _Model_Model__WEBPACK_IMPORTED_MODULE_0__["default"](options));
    }
}
...
/* harmony import */ var _node_modules_riotjs_observable_dist_observable__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../../node_modules/@riotjs/observable/dist/observable */ "./node_modules/@riotjs/observable/dist/observable.js");
/* harmony import */ var _node_modules_riotjs_observable_dist_observable__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_node_modules_riotjs_observable_dist_observable__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _const__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../const */ "./src/ts/const.ts");


class Model {
    constructor(state) {
        this.announcer = _node_modules_riotjs_observable_dist_observable__WEBPACK_IMPORTED_MODULE_0___default()(this);
        this.update(state);
    }
    getState() {
        return this.state;
    ...
    emitState() {
        this.announcer.trigger('change.state', Object.assign({}, this.state));
    }
    get(key) {
    ...
    static validateStep(state) {
        const { step } = state;
        state.step = Number(step) < _const__WEBPACK_IMPORTED_MODULE_1__["DEFAULT_STEP"] ? _const__WEBPACK_IMPORTED_MODULE_1__["DEFAULT_STEP"] : Math.round(step);
        return state;
    }
    ...
    static validateValue(prop, v, state) {
...
/* harmony import */ var _node_modules_riotjs_observable_dist_observable__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../../../node_modules/@riotjs/observable/dist/observable */ "./node_modules/@riotjs/observable/dist/observable.js");
/* harmony import */ var _node_modules_riotjs_observable_dist_observable__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_node_modules_riotjs_observable_dist_observable__WEBPACK_IMPORTED_MODULE_1__);


class View {
    constructor($target) {
        // thing that dealing with events between MPV layers
        this.announcer = _node_modules_riotjs_observable_dist_observable__WEBPACK_IMPORTED_MODULE_1___default()(this);
        // To bind/unbind with class context
        this.funcOnDragStart = e => this.dragStart(e);
        this.funcOnDrag = e => this.drag(e);
        this.funcOnDragEnd = e => this.dragEnd(e);
        this.funcOnJump = e => this.jump(e);
        this.funcOnChangeConfig = e => this.changeConfig(e);
        this.$target = $target;
    }
    onDrag(callback) {
    ...
    renderMainView(state) {
        if (!this.$slider) {
            this.$slider = jquery__WEBPACK_IMPORTED_MODULE_0___default()('<div/>').addClass(View.block);
    ...
    updateConfigView(state) {
        console.log('update config view');
        return this;
    }
    createConfigView(state) {
        if (!state.showConfig) {
            this.$configView.remove();
        }
        this.$configView = jquery__WEBPACK_IMPORTED_MODULE_0___default()('<code/>').addClass(View.conf);
        ...
        jquery__WEBPACK_IMPORTED_MODULE_0___default()('<p/>').html('}').appendTo(this.$configView);
        return this;
    }
    destroyInput() {
        if (this.$input) {
    ...
    createInput() {
        return jquery__WEBPACK_IMPORTED_MODULE_0___default()('<div/>')
            .addClass(View.input)
            .bind('mousedown', this.funcOnJump);
    }
    createSelection() {
        return jquery__WEBPACK_IMPORTED_MODULE_0___default()('<div/>').addClass(View.selection);
    }
    createVisibleRail() {
        return jquery__WEBPACK_IMPORTED_MODULE_0___default()('<div/>').addClass(View.visibleRail);
    }
    createHiddenRail() {
        return jquery__WEBPACK_IMPORTED_MODULE_0___default()('<div/>').addClass(View.hiddenRail);
    }
    bindDocumentEvents() {
        jquery__WEBPACK_IMPORTED_MODULE_0___default()(document)
    ...
    createHandle(type, state) {
        let $handle = jquery__WEBPACK_IMPORTED_MODULE_0___default()('<a/>')
        ...
        if (state.showBubble) {
            const $bubble = jquery__WEBPACK_IMPORTED_MODULE_0___default()('<div/>').addClass(View.bubble).text(type === 'to' ? state.value2 : state.value);
    ...
    renderConfigInputGroup(key, value) {
        let $inputGroup = jquery__WEBPACK_IMPORTED_MODULE_0___default()('<div/>').addClass(View.confInputG);
    ...
    dragStart(e) {
        e.stopPropagation();
        e.preventDefault();
        this.$draggingHandle = jquery__WEBPACK_IMPORTED_MODULE_0___default()(e.currentTarget);
    }
    drag(e) {
    ...
    static valueToPosition(min, max, value) {
        const range = max - min;
...
// Classes
View.block = 'range-slider';
View.blockVert = `${View.block}--vertical`;
View.blockWithBubble = `${View.block}--with-bubble`;
View.conf = `${View.block}__conf`;
View.confLabel = `${View.block}__conf-label`;
View.confInput = `${View.block}__conf-input`;
View.confInputG = `${View.block}__conf-input-group`;
View.input = `${View.block}__input`;
View.hiddenRail = `${View.block}__rail`;
View.visibleRail = `${View.block}__rail--visible`;
View.selection = `${View.block}__selection`;
View.handle = `${View.block}__handle`;
View.bubble = `${View.block}__bubble`;
View.handleFrom = `${View.handle}--from`;
View.handleTo = `${View.handle}--to`;
...
/*!*************************!*\
  !*** ./src/ts/const.ts ***!
  \*************************/
/*! exports provided: DEFAULT_MIN, DEFAULT_MAX, DEFAULT_STEP, DEFAULT_VALUE, DEFAULT_VALUE_2, DEFAULT_RANGE, DEFAULT_VERTICAL, DEFAULT_SHOW_BUBBLE, DEFAULT_SHOW_CONFIG */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "DEFAULT_VALUE_2", function() { return DEFAULT_VALUE_2; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "DEFAULT_RANGE", function() { return DEFAULT_RANGE; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "DEFAULT_VERTICAL", function() { return DEFAULT_VERTICAL; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "DEFAULT_SHOW_BUBBLE", function() { return DEFAULT_SHOW_BUBBLE; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "DEFAULT_SHOW_CONFIG", function() { return DEFAULT_SHOW_CONFIG; });
const DEFAULT_MIN = 0;
...
jquery__WEBPACK_IMPORTED_MODULE_0___default()(document).ready(function () {
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('input#simple').range({
        showConfig: true
    });
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('input#with-step').range({
        step: 10,
        showConfig: true
    });
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('input#with-range').range({
        range: true,
        // value: 20,
        // value2: 30,
        showConfig: true
    });
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('input#vertical').range({
        showConfig: true,
        vertical: true
    });
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('input#with-bubble').range({
        value: 20,
        showBubble: true,
        showConfig: true
    });
...
/* harmony import */ var jquery__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! jquery */ "./node_modules/jquery/dist/jquery.js");
/* harmony import */ var jquery__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(jquery__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _App_App__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./App/App */ "./src/ts/App/App.ts");
/* harmony import */ var _const__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./const */ "./src/ts/const.ts");
...
(function ($) {
    $.fn.range = function (options) {
        const defaults = {
            ...
            range: _const__WEBPACK_IMPORTED_MODULE_2__["DEFAULT_RANGE"],
            vertical: _const__WEBPACK_IMPORTED_MODULE_2__["DEFAULT_VERTICAL"],
            showBubble: _const__WEBPACK_IMPORTED_MODULE_2__["DEFAULT_SHOW_BUBBLE"],
            showConfig: _const__WEBPACK_IMPORTED_MODULE_2__["DEFAULT_SHOW_CONFIG"],
        };
        return this.each(function () {
            $.data(this, 'range', new _App_App__WEBPACK_IMPORTED_MODULE_1__["default"]($(this), Object.assign({}, defaults, options)));
        });
    };
...
/***/ 0:
/*!***********************************************************************!*\
  !*** multi ./src/ts/plugin.ts ./src/ts/demo.ts ./src/scss/index.scss ***!
  \***********************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

__webpack_require__(/*! ./src/ts/plugin.ts */"./src/ts/plugin.ts");
__webpack_require__(/*! ./src/ts/demo.ts */"./src/ts/demo.ts");
