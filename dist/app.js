...
class View {
    ...
    updateConfigInputGroup(key, value) {
    ...
    createConfigInputGroup(key, value) {
    ...
    static createSlider() {
        return jquery__WEBPACK_IMPORTED_MODULE_0___default()('<div/>').addClass(View.block);
    }
    static updateSlider($slider, state) {
        if (state.vertical) {
    ...
    static createInput() {
        return jquery__WEBPACK_IMPORTED_MODULE_0___default()('<div/>').addClass(View.input);
    }
    ...
    getCursorPositionPercent(e) {
        ...
        if (this.isVertical()) {
            position = e.pageY - $rail.offset().top - _const__WEBPACK_IMPORTED_MODULE_2__["HANDLE_RADIUS"];
            percent = position / ($rail.height() / 100);
            return percent;
        }
        position = e.pageX - $rail.offset().left - _const__WEBPACK_IMPORTED_MODULE_2__["HANDLE_RADIUS"];
        percent = position / ($rail.width() / 100);
        return percent;
    }
    getHandlePositionPercent($handle) {
...
/*!*************************!*\
  !*** ./src/ts/const.ts ***!
  \*************************/
/*! exports provided: DEFAULT_MIN, DEFAULT_MAX, DEFAULT_STEP, DEFAULT_VALUE, DEFAULT_VALUE_2, DEFAULT_RANGE, DEFAULT_VERTICAL, DEFAULT_SHOW_BUBBLE, DEFAULT_SHOW_CONFIG, HANDLE_RADIUS */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "HANDLE_RADIUS", function() { return HANDLE_RADIUS; });
const DEFAULT_MIN = 0;
