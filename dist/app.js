...
class App {
    constructor(target, options) {
        this.presenter = new _Presenter_Presenter__WEBPACK_IMPORTED_MODULE_2__["default"](new _View_Slider_View__WEBPACK_IMPORTED_MODULE_1__["default"](target), new _Model_Model__WEBPACK_IMPORTED_MODULE_0__["default"](options));
    }
}
...
class Model {
    ...
    emitState() {
        this.announcer.trigger('change.state', { ...this.state });
    }
    ...
    static validateValue(prop, inValue, state) {
...
class View {
    ...
    createConfigView(state) {
        const $configView = jquery__WEBPACK_IMPORTED_MODULE_0___default()('<code/>').addClass(View.conf);
        $configView
            .append(jquery__WEBPACK_IMPORTED_MODULE_0___default()('<p/>').html('<b>const</b> options = {'));
        const $inputGroups = Object.keys(state).map((key) => this.createConfigInputGroup(key, state[key]));
        $configView
            .append($inputGroups)
            .append(jquery__WEBPACK_IMPORTED_MODULE_0___default()('<p/>').html('}'));
        return $configView;
    }
    ...
    createConfigInputGroup(key, value) {
        const $inputGroup = jquery__WEBPACK_IMPORTED_MODULE_0___default()('<div/>').addClass(View.confInputG);
    ...
    static createHandle(type, state) {
        const $handle = jquery__WEBPACK_IMPORTED_MODULE_0___default()('<a/>').addClass(View.handle);
